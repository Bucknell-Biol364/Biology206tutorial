...
library(ggtree)
```
Note: R may ask you if you want to install all, some, or none of the package. Type a for all and hit enter. 
...
But what if you want to represent a paraphyletic or polypheletic group? What if you have a list of taxa that you want to investigate, but you aren't sure if they are mono/para/polyphyletic? Ggtree has an answer for that as well! The function "groupOTU()" allows you to define wich taxa you want to group and will then trace back to their most recent common ancestor. Since you can define your taxa list however you like, the resulting group may bemonophyletic (clade), polyphyletic or paraphyletic.
